...
random_image_urls = [
    "static/img/img_1.jpeg",
    "static/img/img_2.jpeg",
    "static/img/img_3.jpeg",
    "static/img/img_4.jpeg",
    "static/img/img_5.jpeg",
    "static/img/img_6.jpeg",
    "static/img/img_7.jpeg",
    "static/img/img_8.jpeg",
]

@app.route("/")
def index():
    price = [49999, 2299, 37999, 112099, 15999, 39999, 1069, 2000]
...
@app.route("/main")
def main():
    # Initialize with an empty DataFrame and no message
...
def recommendations():
    if request.method == 'POST':
        ...
        if content_based_rec.empty:
            ...
            random_prices = [random.choice(price) for _ in range(len(content_based_rec))]
